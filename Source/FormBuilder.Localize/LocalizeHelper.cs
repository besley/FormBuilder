...
namespace FormBuilder.Localize
{
    /// <summary>
    /// 本地化语言帮助
    /// </summary>
    public class LocalizeHelper
    {
        ...
        public static string GetBuilderMessage(string key)
        {
            var localMessage = LocalizeUtility.GetMessage(ProjectTypeEnum.Builder, key);
            return localMessage;
        }
        ...
        /// <returns>本地化信息</returns>
        public static string GetBuilderMessage(string key, string message)
        {
            var localMessage = LocalizeUtility.GetMessage(ProjectTypeEnum.Builder, key, message);
            return localMessage;
        }
        ...
        {
            LanguageJsonResourceCachedHelper.SetLang(project, lang);
        }
