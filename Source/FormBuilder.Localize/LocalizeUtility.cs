...
namespace FormBuilder.Localize
{
    ...
    public class LocalizeUtility
    {
        ...
        private static Dictionary<LangTypeEnum, string> GetJSONFileNameByProject(ProjectTypeEnum prjType)
        {
            ...
            dictLang[LangTypeEnum.en] = string.Format("FormBuilder.Localize.{0}.en.json", prjType.ToString());
            dictLang[LangTypeEnum.zh] = string.Format("FormBuilder.Localize.{0}.zh.json", prjType.ToString());
        ...
        {
            var lang = LanguageJsonResourceCachedHelper.GetLang(project);
