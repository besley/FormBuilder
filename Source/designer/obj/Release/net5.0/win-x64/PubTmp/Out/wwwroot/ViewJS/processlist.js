        ...
        if (taskEntity !== null) {
            ...
            processapi.agree(taskID, function (result) {
                if (result.Status === 1) {
                    $.msgBox({
                        title: "Task / Agree",
                        content: kresource.getItem('taskagreedokmsg'),
                        type: "info"
                    });
                    processlist.getTaskList();
                } else {
                    $.msgBox({
                        title: "Task / Agree",
                        content: kresource.getItem('taskagreederrormsg') + result.Message,
                        type: "warn"
                    });
                }
            })
        ...
        if (taskEntity !== null) {
            ...
            processapi.refuse(taskID, function (result) {
                if (result.Status === 1) {
                    $.msgBox({
                        title: "Task / Refuse",
                        content: kresource.getItem('taskrefusedokmsg'),
                        type: "info"
                    });
                    processlist.getTaskList();
                } else {
                    $.msgBox({
                        title: "Task / Refuse",
                        content: kresource.getItem('taskrefusederrormsg') + result.Message,
                        type: "warn"
                    });
                }
            })
